...
class SpQR(BaseBlockwiseQuantization):
    ...
    def w_qdq(self, module, wquantizer):
        mask = module.buf_mask.to_dense() if module.buf_mask.is_sparse else module.buf_mask
    ...
    def save_model(self, path):
        ...
        for _, module in self.model.model.named_modules():
            if hasattr(module, 'buf_mask') and module.buf_mask.is_sparse:
                module.register_buffer('buf_mask', module.buf_mask.to_dense())
